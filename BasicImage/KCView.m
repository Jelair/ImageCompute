...
- (void)drawRect:(CGRect)rect {
    ...
    CGContextSetLineCap(context, kCGLineCapRound);//设置顶点样式，（20，50）和（300，100）是连接点
    /*设置线段样式
     phase:虚线开始的位置
     lengths:虚线长度间隔（例如下面的定义说明第一条线段长度8，然后间隔3重新绘制8点的长度线段。
     当然这个数组可以定义更多元素）
     count:虚线数组元素个数
     */
    ...
    /*设置阴影
     ...
     color:阴影颜色
     */
    CGColorRef color = [UIColor grayColor].CGColor;//颜色转化，由于Quartz 2D跨平台，
    //所以其中不能使用UIKit中的对象，但是UIKit提供了转化方法
